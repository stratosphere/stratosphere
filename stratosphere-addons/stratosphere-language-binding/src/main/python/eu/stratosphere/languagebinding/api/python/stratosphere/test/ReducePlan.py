...
data = env.create_input(CSVInputFormat("/home/shiren/numbers.txt", [Types.INT]))

data.reduce("src/main/python/eu/stratosphere/languagebinding/api/python/stratosphere/test/Reduce.py")\
