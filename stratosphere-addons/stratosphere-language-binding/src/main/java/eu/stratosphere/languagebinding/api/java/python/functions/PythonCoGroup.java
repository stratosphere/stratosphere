...
public class PythonCoGroup<IN1, IN2, OUT> extends CoGroupFunction<IN1, IN2, OUT> implements ResultTypeQueryable {
	...
	public PythonCoGroup(String scriptName, Object info) {
		this.info = info;
	...
	public void open(Configuration ignored) throws IOException {
		String scriptPath = getRuntimeContext().getDistributedCache().getFile(scriptName).getAbsolutePath();
		streamer = inConverter1 == null && inConverter2 == null && outConverter == null
				? new PythonStreamer(this, scriptPath)
				: new PythonStreamer(this, scriptPath, inConverter1, inConverter2, outConverter);
		streamer.open();
	}
