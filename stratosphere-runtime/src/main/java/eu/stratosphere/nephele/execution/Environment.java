...
/**
 * The user code of every task runs inside an <code>Environment</code> object. The environment provides important
 * services to the task. It keeps track of setting up the communication channels and provides access to input
