...
public class DependencyConnectedComponentsITCase extends JavaProgramTestBase {
	...
	public DependencyConnectedComponentsITCase(Configuration config) {
		super(config);
	}
	...
	protected void testProgram() throws Exception {
		DependencyConnectedComponentsProgram.runProgram(curProgId, resultPath);
	}
